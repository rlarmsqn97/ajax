...
<body>
		...
		<div class="form-group row pull-right">
			<div class="col-xs-8">
				<input class="form-control" type="text" id="userName"
					onkeyup="searchFunction()" size="20">
			</div>
			<div class="col-xs-2">
	...
	<div class="container">
	 <table class="table" style="text-align: center; border: 1px solid #dddddd">
			...
			<tbody>
				<tr>
					<td style="backgorund-color: #fafafa; text-align:center;"><h5>이름</h5></td>
					<td><input class="form-control" type="text" id="registerName" size="20"></td>
				</tr>
				<tr>
					<td style="backgorund-color: #fafafa; text-align:center;"><h5>나이</h5></td>
					<td><input class="form-control" type="text" id="registerAge" size="20"></td>
				</tr>
				<tr>
					<td style="backgorund-color: #fafafa; text-align:center;"><h5>성별</h5></td>
					<td>
				...
				<tr>
					<td style="backgorund-color: #fafafa; text-align:center;"><h5>이메일</h5></td>
